 ...
 *
 * @date	11/12/09
 * @author  Wouter van Teijlingen, Sebastiaan Seegers
 * @email	wouter@0xff.nl, Sseegers@gmail.com
 */

#ifndef MAPS_HEADER
#define MAPS_HEADER

#include "../levels/level1/sprites/bullet.h" // Bullets Sprite
...
#include "../levels/level1/sprites/powerup3.h" // powerup3 sprite
